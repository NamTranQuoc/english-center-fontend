            ...
            <div className="gx-layout-sider-header">
                ...
                <Link to="/" className="gx-site-logo">
                    {navStyle === NAV_STYLE_NO_HEADER_MINI_SIDEBAR && width >= TAB_SIZE ?
                        <img alt=""
                             src="https://firebasestorage.googleapis.com/v0/b/englishcenter-bd4ab.appspot.com/o/images%2Flogo.png?alt=media&token=1e9f3c81-c00e-40fb-9be1-6b292d0582c6"/> :
